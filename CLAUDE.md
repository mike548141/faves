...
## Doctrine — inherited from atelier (pinned `atelier@09cd4d2`)
...
- **Source & drift:** canonical doctrine is `../atelier/docs/method/`. At
  ...
  "../atelier" log --oneline 09cd4d2..origin/main` — the parent's published
...
# $F = this repo's checkout. The check PRINTS a diff; empty output is the pass.
A=/Users/mike/.pets/atelier F=/Users/mike/worktrees/faves-floor python3 - <<'EOF'
